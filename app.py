...
# Add the directory containing app.py to Python path
...
.stSuccess, .stWarning, .stError, .stInfo { border-radius: 10px; }
...
# ── Page Routing — simple direct imports, files are in the same folder ────────
if page == "🏠 Home":
    import home
    home.show()
